...
if __name__ == "__main__":   
    ...
    fold_5 = ['Namibia', 'Somalia', 'Cameroon', 'Gabon', 'Tunisia', 'SierraLeone', 'Burundi'] # 'Chad', 'Ethiopia',
    ...
    lightning_model = DeepLabV3_Lightning_ESRI_UrbanRural.load_from_checkpoint(current_ckpt, training_folds=training_folds, validation_fold=val_fold, fold_config=fold_order)
