...
if __name__ == "__main__":   
    ...
    for country in test_fold:
        ...
        lightning_model = DeepLabV3_Lightning_ESRI_UrbanRural.load_from_checkpoint(current_ckpt, training_folds=training_folds, validation_fold=val_fold, test_country=country, fold_config=fold_order)
